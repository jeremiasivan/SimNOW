...
<<<<<<< HEAD
<<<<<<< HEAD:codes/4_all_runs_summary/1_main.Rmd
...
>>>>>>> c9a6eb9 (Add visualisation for ms locus distribution):codes/3_all_runs_summary/1_main.Rmd
=======
...
## Divide-and-Conquer
```{r simsum-dac, eval=FALSE}
df_dac_output <- data.table::data.table(simulation=character(), now_wsize=numeric(), now_acc=numeric(), now_rmse=numeric(), now_aic=numeric(),
                                        dac_min_wsize=numeric(), dac_max_wsize=numeric(), dac_acc=numeric(), dac_rmse=numeric(), dac_aic=numeric())
