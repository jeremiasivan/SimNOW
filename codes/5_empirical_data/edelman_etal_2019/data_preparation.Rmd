...
if (!file.exists(fn_concat_all) || params$redo) {
  ls_concat <- stringr::str_rank(ls_concat, numeric=T)
...
foreach (i=ls_chr) %dopar% {
  input_aln <- ifelse(i=="chr_all",
                      paste0(params$outdir,"/",i,"/all_concat.fa"),
                      paste0(params$outdir,"/",i,"/fasta/concatenation/",i,"_concat.fa"))
  output_aln <- ifelse(i=="chr_all",
                       paste0(params$outdir,"/",i,"/all_concat_filtered.fa"),
                       paste0(params$outdir,"/",i,"/fasta/concatenation/",i,"_concat_filtered_.fa"))
