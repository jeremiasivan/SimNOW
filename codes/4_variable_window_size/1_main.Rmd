...
source(paste0(params$codedir, "/4_variable_window_size/functions.R"))
...
```{r child = paste0(params$codedir,"/4_variable_window_size/2_run.Rmd")}
```

```{r child = paste0(params$codedir,"/4_variable_window_size/3_summary.Rmd")}
```
