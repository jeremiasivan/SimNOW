...
for (top in unique(df_topology_count$topology)) {
    ...
    # create a plot
    plot <- ggplot(df_topology_count_subset, aes(x=wsize, y=count_percentage, group=chr)) +
