...
f_plot_perwindow_topology_dist <- function(df_topology_count, df_topology_count_avg, topology) {
    ...
    if (!is.null(df_topology_count_avg)) {
        plot <- plot + geom_point(data=df_topology_count_avg, aes(x=wsize, y=count_percentage, size=20), colour="red", shape=18) +
            geom_line(data=df_topology_count_avg, aes(x=wsize, y=count_percentage, size=1, alpha=0.2), colour="red")
    }
