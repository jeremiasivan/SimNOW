...
if (length(list.files(dir_perwindow, pattern='*.fa', recursive=FALSE)) == numw && !params$redo) {
  ...
  f_perwindow_run(dir_perwindow, s, numw, s_ln_new, wsizes[1], params$thread)
...
for (i in 1:(length(wsizes)-1)) {
  ...
  f_perwindow_run(dir_perwindow, s, numw, s_ln_new, wsizes[i+1], params$thread)
...
if (file.exists(fn_output) && !params$redo) {
  ...
  df_output <- f_generate_perwindowsum(dir_perwindow, s_ln_new, wsizes[1], len_taxa, params$min_informative_sites, params$thread)
...
for (i in 1:(length(wsizes)-1)) {
  ...
  # extract the summary of each window
  df_output <- f_generate_perwindowsum(dir_perwindow, s_ln_new, wsizes[i+1], len_taxa, params$min_informative_sites, params$thread)
