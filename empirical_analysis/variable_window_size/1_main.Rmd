...
source(paste0(params$codedir, "/variable_window_size/functions.R"), local=TRUE)
...
```{r child = paste0(params$codedir,"/variable_window_size/2_run.Rmd")}
```
