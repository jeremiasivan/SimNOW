...
# window alignments for longest window size
# create outdir
...
if (length(list.files(dir_perwindow, pattern='*.fa$', recursive=TRUE)) == numw && !params$redo) {
  log4r::info(fn_logger, paste0("File found: ", wsizes[1], "bp window alignment for step 1."))
} else {
  # generate window alingments and trees
