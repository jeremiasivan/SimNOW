...
params:
  prefix: "hl"
  outdir: "~/Documents/simulation/040423"
---
...
for (s in simulation) {
  fn_msfile <- paste0(params$outdir, "/", s, "/", s, ".ms")
...
for (r in unique(locuslen$rho)) {
  ...
  write.table(data.frame(cbind(r, round(mean(outperr$length),5), round(sd(outperr$length),5))),
