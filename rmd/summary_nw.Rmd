...
fn_simsum <- paste0(params$outdir, "/", params$prefix, ".simsum")
fn_simfig <- paste0(params$outdir, "/", params$prefix, ".simsum.tiff")
...
window_sizes <- subset(window_sizes, window_sizes != paste0(simulation[1],".summary"))
...
for (i in simulation) {
  ...
  fn_sum <- paste0(params$outdir,"/",i,"/windows/",i,".sum")
...
for (i in unique(sub_output$r)) {
  fn_simfig <- paste0(params$outdir, "/", params$prefix, ".simsum.r",i,".tiff")
