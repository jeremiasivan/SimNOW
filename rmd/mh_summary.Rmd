...
fn_hmmsum_nw <- paste0(mast_nw_outdir, params$prefix, ".hmmnow")
...
if (mast_analysis == HiMAST) {
  ...
  trees <- data.table::data.table(start = character(), stop = numeric(), tree = numeric())
  last_pos <- 0
