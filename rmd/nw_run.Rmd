...
nwcl <- makeCluster(params$thread, type = "SOCK", port = 0)
registerDoSNOW(nwcl)
...
for (i in window_sizes) {
  ...
  smfile <- read.table(paste0(window_outdir,i,"/summary/",params$prefix,".atsum"))
  ...
  for (t in unique_topology) {
    ...
    write.fasta(sequences=subfasta, names=names(subfasta), file.out=paste0(temp_outdir,"G",count,".fa"), nbchar = 100)
