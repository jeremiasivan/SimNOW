...
for (i in window_sizes) {
  ...
  iqtree_file <- file(description = paste0(window_outdir, i, "/trees/", params$prefix, ".treefile", sep=""), open="r", blocking = TRUE)
...
for (i in window_sizes) {
  ...
  smfile <- read.table(paste0(window_outdir,i,"/summary/",params$prefix,".atsum", sep=""))
  ...
  write.table(newick_map, paste0(temp_outdir, "../", params$prefix, ".map", sep=""), quote = F, row.names = F, col.names = F)
