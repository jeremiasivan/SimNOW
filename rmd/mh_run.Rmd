...
if (mast_analysis == HiMAST) {
  ...
  stopCluster(nwcl)
  log4r::info(fn_logger, "File created: window-based HiMAST runs.")
}
```
...
if (mast_analysis == HiMAST) {
  ...
  simulation_dir <- paste0(params$outdir, "/", params$prefix, "/simulation/")
  fn_fasta <- paste0(simulation_dir, params$prefix, ".fa")
  fn_uqtops <- paste0(simulation_dir, params$prefix, ".uqtops")
