...
for (i in window_sizes) {
  ...
  if (all(file.exists(fn_cmp, fn_figure)) && !params$redo) {
    log4r::info(fn_logger, paste0("File found: ", i, "bp window comparison file.", sep=""))
    next
  }
...
log4r::info(fn_logger, paste0("File created/modified: NOW accuracy vs NOW IC correlation plots.", sep=""))
