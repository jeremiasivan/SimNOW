...
for (i in window_sizes) {
  ...
  smfile <- read.table(paste0(temp_outdir, params$prefix, ".atsum", sep=""))
...
log4r::info(fn_logger, paste("Files created/modified: NOW accuracy vs NOW IC correlation plots.", sep=""))
```