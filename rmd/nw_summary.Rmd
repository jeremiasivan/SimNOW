...
for (i in window_sizes) {
  ...
  if (all(file.exists(fn_cmp, fn_figure)) && !params$redo) {
    log4r::info(fn_logger, paste0("File already exists: ", i, "bp window comparison file. Skipped.", sep=""))
    next
  }
  ...
  for (j in 1:nrow(msfile)){
    ...
    if (all(is.na(sites))) {
      log4r::warn(fn_logger, paste0("Total length of ", i, "bp window does not match with msfile.", sep=""))
      break
    }
  ...
  log4r::info(fn_logger, paste0("Files created: ", i, "bp window comparison files (",
...
log4r::info(fn_logger, paste0("File created/modified: summary table of NOW and ms (", params$prefix, ".sum).", sep=""))
...
log4r::info(fn_logger, paste0("Files created/modified: NOW accuracy vs NOW IC correlation plots.", sep=""))
